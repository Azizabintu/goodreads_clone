...
class Review(models.Model):
    ...
    book = models.ForeignKey(Book, on_delete=models.CASCADE,related_name= "bookreview_set")
    ...
    def __str__(self):
        return f"{self.stars_given} stars given for {self.book.title} by {self.user.username}"
